...
function init(){
	...
	var confmKey = "U01TX0FVVEgyMDE4MDQwNDE2NTA1MzEwNzc5NDE=";
...
<body onload="init();">
	<form id="form" name="form" method="post">
		<input type="hidden" id="confmKey" name="confmKey" value="U01TX0FVVEgyMDE4MDQwNDE2NTA1MzEwNzc5NDE="/>
		<input type="hidden" id="returnUrl" name="returnUrl" value="2"/>
